...
public class KeycloakService {
    ...
    @PostConstruct
    public void init() {
        KEYCLOAK_ADMIN_API = KEYCLOAK_BASE_URL + "/admin/realms/" + REALM + "/users";
...
//    }
    ...
    public KeycloakRole getRoleByName(String clientId, String token, String role) {
        ...
        String url = KEYCLOAK_BASE_URL + "/admin/realms/" + REALM + "/clients/" + clientId + "/roles/" + role;
    ...
    public KeycloakUserDTO fetchFirstUserByUsername(String username, String token) throws Exception {
        ...
        String url = KEYCLOAK_BASE_URL + "/admin/realms/" + REALM + "/users?username=" + username;
    ...
    public void assignRoleToUser(String userId, String clientId, List<KeycloakRole> roles, String token) throws Exception {
        ...
        String url = KEYCLOAK_BASE_URL + "/admin/realms/" + REALM + "/users/" + userId + "/role-mappings/clients/" + clientId;
    ...
    public KeycloakUserDTO fetchUserProfileByJwt(String token) throws Exception {
        ...
        String url = KEYCLOAK_BASE_URL + "/realms/" + REALM + "/protocol/openid-connect/userinfo";
